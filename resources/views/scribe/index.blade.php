...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "http://local.fixmymind.org:8000";
        var useCsrf = Boolean();
                ...
                <li class="tocify-item level-1" data-unique="chat">
                    <a href="#chat">Chat</a>
                                    ...
                                    <ul id="tocify-subheader-chat" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="chat-GETapi-health">
                                <a href="#chat-GETapi-health">Healthcheck</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<p>API terapeutyczne do rozmów z AI</p>
<aside>
...
<p>To authenticate requests, include a <strong><code>Authorization</code></strong> header with the value <strong><code>"Basic {credentials}"</code></strong>.</p>
<p>All authenticated endpoints are marked with a <code>requires authentication</code> badge in the documentation below.</p>
<p>Use Basic Auth with your credentials (username:password encoded in Base64).</p>

        <h1 id="chat">Chat</h1>

    

                                <h2 id="chat-GETapi-health">Healthcheck</h2>
...
<div class="bash-example">
    ...
    --get "http://local.fixmymind.org:8000/api/health" \
...
<div class="javascript-example">
    ...
    "http://local.fixmymind.org:8000/api/health"
);
...
<div class="bash-example">
    ...
    "http://local.fixmymind.org:8000/api/chat" \
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-chat"
               value="Basic {credentials}"
               data-component="header">
    <br>
<p>Example: <code>Basic {credentials}</code></p>
            </div>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
